...
const ProgramInfo = () => {
    ...
    const typingText = useTypingEffect("Bienvenidos a VML Academy nuestro programa de formación para estudiantes universitarios", 30); 
    ...
    return (
        <div>
            <div id="acercade" ref={ref} className={`opacitycontainer container mt-3 ${isVisible ? 'fade-in' : ''}`}>
                ...
                {/* <p>Bienvenidos a <strong>VML Academy</strong> nuestro programa de formación para estudiantes universitarios.</p> */}
                ...
                <p>Las inscripciones serán gratuitas y se abrirán 25 cupos (aprox). El programa será certificado por VML a aquellos con más de un 80% de asistencia. Además, al finalizar el programa, se seleccionarán dos alumnos para una práctica remunerada de 3 meses en la agencia (meses a convenir).</p>
